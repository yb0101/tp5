<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/shop\my.html";i:1507451902;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="/image/土狗子.jpg" width="60" height="60" />
            </div>
            <div class="col-xs-9">
                土狗子<br/>
                西国贸大厦<br/>
                积分:<span class="text-danger">10000</span>
            </div>
        </div>
        <div class="blank"></div>
