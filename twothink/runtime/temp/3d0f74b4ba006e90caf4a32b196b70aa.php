<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/property\edit.html";i:1506673796;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">标题（简述保修问题）<span class="check-tips"></span></label>
        <div class="controls">
            <input type="text" class="text input-large" name="title" value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">内容<span class="check-tips">（详细描述报修内容）</span></label>
        <div class="controls">
