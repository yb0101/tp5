<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\twothink\public/../application/user/view/default/login\index.html";i:1506686248;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
...
<div class="main">
  ...
  <div class="container-fluid">
    <form method="post">
      ...
      <!--</div>-->
      <div class="form-group">
        <button class="btn btn-primary onlineBtn">确定登陆</button>
      </div>
    </form>
  </div>
</div>
